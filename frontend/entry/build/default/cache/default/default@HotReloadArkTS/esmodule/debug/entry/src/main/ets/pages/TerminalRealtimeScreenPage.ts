...
interface TerminalRealtimeScreenPage_Params {
    state?: PageLoadState;
    events?: RealtimeAuthEvent[];
}
...
class TerminalRealtimeScreenPage extends ViewPU {
    ...
    setInitiallyProvidedValue(params: TerminalRealtimeScreenPage_Params) {
    ...
    updateStateVars(params: TerminalRealtimeScreenPage_Params) {
    }
    ...
    private __events: ObservedPropertyObjectPU<RealtimeAuthEvent[]>;
    get events() {
        return this.__events.get();
    }
    set events(newValue: RealtimeAuthEvent[]) {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.state !== 'ready') {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(`${this.events.length} 条`);
                        Text.fontSize(18);
                        Text.fontWeight(FontWeight.Bold);
                        Text.fontColor('#DFF6FF');
                    }, Text);
                    Text.pop();
                    Row.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Row.borderRadius(8);
                                Row.border({ width: 1, color: item.riskLevel === 'high' ? AppColors.danger : AppColors.border });
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(`${item.terminal} · ${item.studentId}`);
                                Text.fontSize(16);
                                Text.fontWeight(FontWeight.Bold);
                            ...
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(`结果 ${item.result} · 延迟 ${item.latency}`);
                                Text.fontSize(12);
                        ...
                        this.forEachUpdateFunction(elmtId, this.events, forEachItemGenFunction, (item: RealtimeAuthEvent): string => item.id, false, false);
                    }, ForEach);
                    ForEach.pop();
                });
            }
    ...
    static getEntryName(): string {
        return "TerminalRealtimeScreenPage";
    }
}
registerNamedRoute(() => new TerminalRealtimeScreenPage(undefined, {}), "", { bundleName: "com.example.campusauth", moduleName: "entry", pagePath: "pages/TerminalRealtimeScreenPage", pageFullPath: "entry/src/main/ets/pages/TerminalRealtimeScreenPage", integratedHsp: "false", moduleType: "followWithHap" });
